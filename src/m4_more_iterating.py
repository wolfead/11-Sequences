...
def run_test_sum_sequence():
    ...
    # -------------------------------------------------------------------------
    # Test 1 (using an ORACLE to compute the expected answer):
    # -------------------------------------------------------------------------
...
def run_test_count_positive_sines():
    ...
    actual = count_positive_sines(sequence)
    print()
    print('Test Mine expected:', expected)
    print('          actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    sequence = [2,3,6,7,4,2]
    actual = sum_first_n(sequence,2)
    expected = 5
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
